...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Xa(e,t,n){let r=new Float32Array(Ia),i=new U(0,1,0);return new ji({name:`SphericalGaussianBlur`,defines:{n:Ia,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Za(){return new ji({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:$a(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Qa(){return new ji({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:$a(),fragmentShader:`
	...
	`}var eo=class extends rn{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new vi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Ts={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Es(e,t){let n=Ts[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ds=new U;function Os(){return G.getLuminanceCoefficients(Ds),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ds.x.toFixed(4)}, ${Ds.y.toFixed(4)}, ${Ds.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=_s(i,i.VERTEX_SHADER,y),S=_s(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.hasPositionAttribute===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1){if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Cs(i,x,`vertex`),n=Cs(i,S,`fragment`);V(`WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
`,Vc=`
  ...
  uniform vec4 u_blobs[${zc}];   // x, y, radius, opacity
  uniform vec3 u_blobColors[${zc}];
...
`,Hc=class{constructor(e){this.reset(e)}reset(e){this.x=Math.random(),this.y=Math.random(),this.baseRadius=Math.random()*.25+.15,this.color=e[Math.floor(Math.random()*e.length)],this.driftX=(Math.random()-.5)*.04,this.driftY=(Math.random()-.5)*.05,this.fadeInTime=Math.random()*2+2,this.holdTime=Math.random()*3+2,this.fadeOutTime=Math.random()*2+2,this.age=0,this.totalLife=this.fadeInTime+this.holdTime+this.fadeOutTime,this.delay=Math.random()*6}update(e){return this.age+=e,this.x+=this.driftX*e,this.y+=this.driftY*e,this.age>this.delay+this.totalLife}getOpacity(){let e=this.age-this.delay;if(e<0)return 0;if(e<this.fadeInTime)return e/this.fadeInTime;if(e<this.fadeInTime+this.holdTime)return 1;let t=e-this.fadeInTime-this.holdTime;return Math.max(0,1-t/this.fadeOutTime)}getRadius(){let e=this.getOpacity();return this.baseRadius*(.7+.3*e)}};function Uc(){let e=(0,f.c)(4),t=(0,l.useRef)(null),n;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(n={x:.5,y:.5},e[0]=n):n=e[0];let r=(0,l.useRef)(n),i,a;e[1]===Symbol.for(`react.memo_cache_sentinel`)?(i=()=>{let e=t.current;if(!e)return;let n=[new K(1,.878,.878),new K(1,.973,.827),new K(.843,.933,1),new K(.91,.969,.812)],i=new Un,a=new ra(-1,1,1,-1,0,1),o=new Rc({antialias:!0});o.setPixelRatio(Math.min(window.devicePixelRatio,2)),o.setSize(e.clientWidth,e.clientHeight),e.appendChild(o.domElement);let s=Array.from({length:6},()=>new Hc(n)),c={u_resolution:{value:new Lt(e.clientWidth,e.clientHeight)},u_activeCount:{value:6},u_blobs:{value:Array.from({length:zc},Gc)},u_blobColors:{value:Array.from({length:zc},Wc)},u_bgColor:{value:new K(1,.996,.992)}},l=new Lr,u=new Float32Array([-1,-1,3,-1,-1,3]),d=new Float32Array([0,0,2,0,0,2]);l.setAttribute(`position`,new Sr(u,2)),l.setAttribute(`uv`,new Sr(d,2));let f=new ji({vertexShader:Bc,fragmentShader:Vc,uniforms:c}),p=new oi(l,f);i.add(p);let m=t=>{let n=e.getBoundingClientRect();r.current={x:(t.clientX-n.left)/n.width,y:1-(t.clientY-n.top)/n.height}};window.addEventListener(`mousemove`,m);let h=()=>{let t=e.clientWidth,n=e.clientHeight;o.setSize(t,n),c.u_resolution.value.set(t,n)};window.addEventListener(`resize`,h);let g=new ba,_,v=()=>{let e=g.getDelta(),t=r.current;s.forEach((r,i)=>{r.update(e)&&r.reset(n);let a=t.x-r.x,o=t.y-r.y;r.x+=a*.02*e,r.y+=o*.02*e,c.u_blobs.value[i].set(r.x,r.y,r.getRadius(),r.getOpacity()),c.u_blobColors.value[i].copy(r.color)}),o.render(i,a),_=requestAnimationFrame(v)};return v(),()=>{cancelAnimationFrame(_),window.removeEventListener(`mousemove`,m),window.removeEventListener(`resize`,h),l.dispose(),f.dispose(),o.dispose(),e.removeChild(o.domElement)}},a=[],e[1]=i,e[2]=a):(i=e[1],a=e[2]),(0,l.useEffect)(i,a);let o;return e[3]===Symbol.for(`react.memo_cache_sentinel`)?(o=(0,m.jsx)(`div`,{ref:t,style:{position:`fixed`,inset:0,width:`100%`,height:`100%`,zIndex:-1}}),e[3]=o):o=e[3],o}function Wc(){return new K}function Gc(){return new tn}function Kc(){let e=(0,f.c)(2),t;e[0]===Symbol.for(`react.memo_cache_sentinel`)?(t=(0,m.jsx)(h,{}),e[0]=t):t=e[0];let n;return e[1]===Symbol.for(`react.memo_cache_sentinel`)?(n=(0,m.jsxs)(`div`,{className:`app flex h-screen w-screen items-stretch gap-20 sm:flex-col`,children:[t,(0,m.jsxs)(`div`,{className:`content px-[100px] py-[80px] flex flex-col overflow-scroll sm:overflow-auto w-full h-screen items-end snap-y gap-30`,children:[(0,m.jsx)(`div`,{className:`bg-amber-700 min-h-screen snap-center`}),(0,m.jsx)(_,{}),(0,m.jsx)(v,{}),(0,m.jsx)(S,{}),(0,m.jsx)(O,{})]}),(0,m.jsx)(Uc,{})]}),e[1]=n):n=e[1],n}(0,u.createRoot)(document.getElementById(`root`)).render((0,m.jsx)(l.StrictMode,{children:(0,m.jsx)(Kc,{})}));